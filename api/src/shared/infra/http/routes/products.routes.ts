...
productsRoutes.get("/1/available", getAvailableProductsController.handle);
productsRoutes.get("/:category_id/category", getProductsByCategoryController.handle);
productsRoutes.get("/1/featured", getFeaturedProductsController.handle);
productsRoutes.get("/1/offer", getOfferProductsController.handle);
productsRoutes.post("/:id/colors", ensureAuthenticated, ensureAdminOrSeller, createColorsProductController.handle);
productsRoutes.post("/:id/materials", ensureAuthenticated, ensureAdminOrSeller, createMaterialsProductController.handle);
...
productsRoutes.post("/:id/images", ensureAuthenticated, ensureAdminOrSeller, upload.array("images"), createImagesProductController.handle);
