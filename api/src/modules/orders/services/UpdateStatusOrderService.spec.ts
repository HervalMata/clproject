...
describe('Update Status Order', () => {
    beforeEach(() => {
        ...
        updateStatusOrderService = new UpdateStatusOrderService(ordersRepositoryInMemory, dateProvider, statusOrderRepositoryInMemory);
    });
    ...
    it('should be able to update an status order', async () => {
        ...
        await expect(updateStatusOrderService.execute({
            id: order_id,
